...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title: t("title"), description: t("description"), url: `${BASE_URL}/${locale}/vehicles`, type: "website" },
    alternates: { canonical: `${BASE_URL}/${locale}/vehicles`, languages: Object.fromEntries(routing.locales.map((l) => [l, `${BASE_URL}/${l}/vehicles`])) },
  };
}
