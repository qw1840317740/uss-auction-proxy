...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title: t("title"), description: t("description"), url: `${BASE_URL}/${locale}/services/maintenance`, type: "website" },
    alternates: { canonical: `${BASE_URL}/${locale}/services/maintenance`, languages: Object.fromEntries(routing.locales.map((l) => [l, `${BASE_URL}/${l}/services/maintenance`])) },
  };
}
